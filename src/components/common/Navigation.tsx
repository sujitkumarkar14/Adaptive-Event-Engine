...
export const SideNavBar = () => {
  ...
  return (
    <nav className="hidden md:flex fixed left-0 top-0 h-full w-72 bg-[#faf9fd] dark:bg-[#1a1b1e] border-r-[1px] border-[#727785] flex-col pt-8 z-40">
      <div className="px-8 mt-12 mb-12">
        <div className="text-2xl font-black mb-1 uppercase tracking-tighter">Attendee Portal</div>
